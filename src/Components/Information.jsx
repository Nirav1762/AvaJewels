    ...
    <div>
        <div className='informationSection'>
            <div className='informationCard'>
                    <SmartImage style= {{objectFit:"contain", width:"30%"}} src='src\assets\Images\Truck.png'></SmartImage>
            ...
            <div className='informationCard'>
                    <SmartImage style= {{objectFit:"contain", width:"30%", transform: "scale(0.7)"}} src='src\assets\Images\Sheild.png'></SmartImage>
            ...
            <div className='informationCard'>
                    <SmartImage style= {{objectFit:"contain", width:"30%", transform: "scale(0.7)"}} src='src\assets\Images\Docs.png'></SmartImage>
            ...
            <div className='informationCard'>
                    <SmartImage style= {{objectFit:"contain", width:"30%", transform: "scale(0.7)"}} src='src\assets\Images\Diamonds.png'></SmartImage>
